...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
    ...
    public List<SysMenuOutVO> selectSysMenuList(Integer type, Long parentId) {
        ...
        return ListUtils.n(sysMenuList).list(eachSysMenu -> new SysMenuOutVO().toSysMenuOutVO(eachSysMenu, null)).to();
    }
    ...
    public SysMenuDetailOutVO selectSysMenuDetail(Long mid) {
        ...
        return new SysMenuDetailOutVO().toSysMenuDetailOutVO(sysMenu, parentMenuName);
    }
    ...
    public void delSysMenu(Long mid) {
        ...
        log.info("查询菜单ID：{} 下的子菜单数量为：{}", mid, childrenCount);
    ...
    public List<SysMenuSimpleOutVO> selectAllSysMenuList() {
        ...
        return ListUtils.n(sysMenuList).list(eachSysMenu -> new SysMenuSimpleOutVO().toSysMenuSimpleOutVO(eachSysMenu)).to();
    }
