...
import com.yss.shopping.user.mapper.user.SysRoleMapper;
...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements SysRoleService {
    ...
    public List<SysRoleOutVO> selectSysRoleList(Long parentId) {
        ...
        return ListUtils.n(sysRoleList).list(eachSysRole -> new SysRoleOutVO().toSysRoleOutVO(eachSysRole)).to();
    }
    ...
    public SysRoleDetailOutVO selectSysRoleDetail(Long rid) {
        ...
        return new SysRoleDetailOutVO().toSysRoleDetailOutVO(sysRole, parentRoleName);
    }
    ...
    public List<Long> selectParentRidList(Long rid, Integer parentRoleState) {
        ...
        return this.sysRoleMapper.selectParentRidList(rid, parentRoleState);
    }
    ...
    public List<Long> selectChildrenRidList(Long rid, Integer childrenRoleState) {
        ...
        Assert.notNull(rid, "操作失败：rid不能为空");
        return this.sysRoleMapper.selectChildrenRidList(rid, childrenRoleState);
    }
    ...
    public Long selectParentRid(Long rid) {
        ...
        SysRole sysRole = this.sysRoleMapper.selectById(rid);
        if (null != sysRole) {
            parentRid = sysRole.getParentId();
        }
        log.info("查询到的父角色ID为：{}", parentRid);
        return parentRid;
    }
